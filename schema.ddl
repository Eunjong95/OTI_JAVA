...
ALTER TABLE oderdetails 
    ADD CONSTRAINT oderdetails_pk PRIMARY KEY ( pno,ono );
...
ALTER TABLE products 
    ADD CONSTRAINT pprice_ck CHECK ( pprice >= 0 );

ALTER TABLE products 
    ADD CONSTRAINT products_pk PRIMARY KEY ( pno );
...
ALTER TABLE users 
    ADD CONSTRAINT users__un UNIQUE ( usertel );

ALTER TABLE oderdetails
    ADD CONSTRAINT oderdetails_orders_fk FOREIGN KEY ( ono )
        REFERENCES orders ( ono );

ALTER TABLE oderdetails
    ADD CONSTRAINT oderdetails_products_fk FOREIGN KEY ( pno )
